package com.example.shaohui.oneselfall.common.clock;
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray tArray = context.obtainStyledAttributes(attrs,
                    R.styleable.FilpClock);
            textSize = tArray.getDimension(R.styleable.FilpClock_TextSize, 26f);
            textColor = tArray.getColor(R.styleable.FilpClock_TextColor, 0xffffff);
            textBg = tArray.getDrawable(R.styleable.FilpClock_TextBackground);
            isUp2Down = tArray.getBoolean(R.styleable.FilpClock_UpOrDown, true);
...
//        int invisibleValue = visibleValue - 1;
        mInvisibleTextView.setText(String.valueOf(visibleValue));
    }

    /**
     * @param isUp2Down 方向标识 true: 从上往下翻  , false: 从下往上翻
     */
